...
import {
    paddockSchema,
    updatePaddockSchema,
    paddockResponseSchema,
    paddockListResponseSchema
} from '../validators/PaddockValidator.js';
...
export function createPaddockRouter(paddockController: PaddockController) {
